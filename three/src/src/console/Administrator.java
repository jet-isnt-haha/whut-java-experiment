...
public class Administrator extends console.AbstractUser
{
            ...
            try {
                ...
                switch (a) {
                    case 1: {
                        ...
                        if (console.DataProcessing.insertUser(name, password, role)){
                    ...
                    case 4: {
                        Enumeration<console.AbstractUser> allUsers = listUser();
